...
public final class Constants {
    ...
    public static class VisionConstants {
        ...
        // Transform from CAD for mount
        private static final double camYaw = Math.toRadians(38.23);
        private static final double camPitch = Math.toRadians(13.00);
        private static final double camRoll = Math.toRadians(0.00);
        private static final double camZ = +0.2003;
        private static final double camX = +0.3228;
        private static final double camY = -0.3383;

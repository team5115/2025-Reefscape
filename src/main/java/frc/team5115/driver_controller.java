...
public class driver_controller {
    ...
    public driver_controller(int port,Drivetrain drivetrain,Dispenser dispenser,Dealgaefacationinator5000 dealgae,Elevator elevator,Climber climber,Intake intake){

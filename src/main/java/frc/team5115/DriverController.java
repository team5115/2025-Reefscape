...
public class DriverController {
    ...
    private void configureRumbleBindings(Drivetrain drivetrain, Dispenser dispenser, Elevator elevator) {
        drivetrain
                .alignedAtGoalTrigger()
                .onTrue(rumble(Constants.RUMBLE_STRENGTH)).onFalse(rumble(0));
        dispenser
                .coralDetected()
